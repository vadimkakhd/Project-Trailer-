...
швидко знайти фільм у кінотеатрі, що зацікавив, або інформацію про нього: акторський склад, відгуки, переглянути
трейлер тощо, сеанс та купити квитки. Людям не потрібно
